...
t.minimumved = "1.8.2"  -- The minimum version of Ved this plugin is designed to work with. If unsure, just use the latest version.
t.description = [[
it's just text replacement but special
